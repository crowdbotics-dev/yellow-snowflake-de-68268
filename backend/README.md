...
## Project Structure
    ...
    ├── yellow_snowflake_de_68268  # Django project configurations
...
1. Clone this repo and `cd yellow_snowflake_de_68268`
...
2. Clone this repo and `cd yellow_snowflake_de_68268`
