"""
Django settings for yellow_snowflake_de_68268 project.
...
ROOT_URLCONF = 'yellow_snowflake_de_68268.urls'
...
WSGI_APPLICATION = 'yellow_snowflake_de_68268.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yellow_snowflake_de_68268 API",
    "DESCRIPTION": "API documentation for yellow_snowflake_de_68268 App",
    "VERSION": "v1",
}
